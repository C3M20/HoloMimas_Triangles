...
public class GridGenerator2 : MonoBehaviour
{
    ...
    void Start()
    {
        lines = ColorsFile.text.Trim().Split('\n');
    ...
    void DrawGrid()
    {
        ...
        Debug.Log("Number of Vertecies: "+vertCounter);
        ...
        for (int k = 0; k < Slices; k++)
        {
            ...
            {                
                for (int j = 0; j < Rows - 2; j++)
                {
                    ...
                    Color thisSquareColor = getSquareColor(colorReader);
                    vertColors[idx] = thisSquareColor;
                    vertColors[idx + 1] = thisSquareColor;
                    vertColors[idx + 2] = thisSquareColor;
                    vertColors[idx + 3] = thisSquareColor;
                    vertColors[idx + 4] = thisSquareColor;
                    vertColors[idx + 5] = thisSquareColor;
        ...
        getNewMesh(mesh_ob, verts, uvs, triangs, vertColors);
        Debug.Log("Counter of lines: " + colorReader);
    }
    ...
    Color getSquareColor(int i)
    {
        ...
        colorValue = MapRange(colorValue, 0, 800, 0, 255);   
        return new Color(colorValue, colorValue,colorValue);
    }
    int MapRange(int value, int inlow, int inhigh, int outlow, int outhigh)
    {
